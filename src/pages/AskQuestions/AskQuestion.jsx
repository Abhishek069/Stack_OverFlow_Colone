                ...
                <form onSubmit={handleSubmit}>
                    <div className="ask-form-container">
                        <label htmlFor="ask-ques-title">
                            ...
                            <input type="text" id="ask-ques-title" onChange={(e) => {setQuestionTitle(e.target.value)}} placeholder="e.g. Is there an R function foro finding the index of an element in a vector?"/>
                        </label>
                    ...
                    <input type="submit" value='Reivew yout question' className="review-btn" />
                </form>
